...
?>
		  <tr>
				...
				<td><input type="radio" name="action"  value="Approve" >Approve&nbsp;&nbsp;
					<input type="radio" name="action"  value="Waiting" >Waiting</td>
	 ...
	 <div class="btn">
		<a href="alertdb.php" > <button name="actionbtn" align="center">Update status</button></a>
	</div>
	</form>
	 <!--database connection-->
