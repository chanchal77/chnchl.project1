...
?>
		  <tr>
				...
				<td><button name="update"><a href="update.php?id=<?php echo $row['id']; ?>">Update</a></button></td>
				<td><button name="update" onclick="myFunction()"><a href="delete.php?id=<?php echo $row['id']; ?>">Delete</a></button></td>
				<?php
		 }
				?>
            </tr>
