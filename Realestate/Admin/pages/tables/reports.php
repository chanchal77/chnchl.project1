...
<div class="wrapper">
  ...
  <div class="content-wrapper">
	...
	<form action="regi_report.php" method="post">
		...
		<tr>
			<td colspan="3" align="center" >
				<input type="radio" name="citywise">&nbsp; &nbsp; Registration Report Date Wise</td>
				<td colspan="3" align="center"><input type="radio" name="citywise">&nbsp; &nbsp;Property Reports Date wise</td>
				<td colspan="" align="center"><input type="radio" name="citywise">&nbsp; &nbsp;Property Reports through Particular Users&nbsp; &nbsp;&nbsp; &nbsp;</td>
			</td>
		</tr>
	
		<tr>
			
			<td><input type="text" name="date_from1" placeholder="from"></td>
			<td>To</td>
			<td><input type="text" name="date_to1" placeholder="To"></td>
			
			
			<td><input type="text" name="date_from2" placeholder="from"></td>
			<td>To</td>
			<td><input type="text" name="date_to2" placeholder="To"></td>
			</td>
  ...
  <footer class="main-footer">
   <center>   <strong>Copyright &copy; 2019 All rights reserved. Design & Developed By <a href="https://vsystechnology.com/" target="_blank">vsys Technology </a>.</strong> </center>
  </footer>
