...
<?php
	...
	?>
<form action="alertdb.php?id=<?php echo $row['id']; ?>" method="post">
...
?>
		  <tr>
				...
				<td><img src='<?php echo $row['regi_image'] ?>'class="img-responsive" alt="image" height="150" width="150"/ name="img"></td>
				...
				<td><input type="radio" name="action"  value="Approve" >Approve&nbsp;&nbsp;
					...
					<td><button onclick="alertdb.php?id=<?php echo $row['id']; ?>">submit</button>
					</td>
