  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
		...
		<li><a href="data.php"><i class="fa fa-bell-o" aria-hidden="true"></i><span>Alert</span></a></li>
  </aside>
...
?>
		  <tr>
				...
				<td><img src='<?php echo $row['image'] ?>'class="img-responsive" alt="image" height="50" width="50"/></td>
				...
				<td><input type="checkbox" name="action" value="checked" id="myCheck" ></a></td>
				<td><input type="button" name="actionbutton"  value="Approve"></td>
	 ...
	 <div class="btn">
		 <button name="actionbtn" align="center" onclick="myFunction()">Update status</button>
	</div>
