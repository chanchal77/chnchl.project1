...
<div class="wrapper">
  ...
  <div class="content-wrapper">
	...
	<?php
		$query = "SELECT * FROM registration where category='agent'"; 
...
?>
		  <tr>
				...
				<td><img src='<?php echo $row['regi_image'] ?>'class="img-responsive" alt="image" height="50" width="50"/></td><td><?php echo $row['username']; ?></td>
  ...
  <footer class="main-footer">
   <center>   <strong>Copyright &copy; 2019 All rights reserved. Design & Developed By <a href="https://vsystechnolo//" target="_blank">VSYS Technology </a>.</strong> </center>
  </footer>
