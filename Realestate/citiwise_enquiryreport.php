...
<section id="agent-2-peperty" class="my-pro padding">
    ...
    <div class="row">
      <div class="col-md-12">
        <ul class="f-p-links margin_bottom">
		  ...
		  <li><a href="enquiry_Report.php" class="active"></i>Report</a></li>
  ...
  <?php
  session_start();
	if(isset($_POST['submit2']) && ['username']== $Name){
		$id=$_GET['id'];
		...
		$query = "SELECT * FROM contact where date between '$from' and '$to'"; 
		$result = mysqli_query($con,$query);
	}
	elseif(isset($_POST['submit1'])&& ['username']== $Name){
	$id=$_GET['id'];
