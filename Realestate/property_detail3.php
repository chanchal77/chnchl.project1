...
<title>Sbook | Property Detail</title>
      ...
      <div class="container">
         <div class="row">
            <div class="col-md-3 col-sm-12">
               <div class="logo"><a href="index.jpg"><img alt="" src="images/myhouse.jpg" width="100px" height="50px"></a></div>
            </div>
            <!--Info Box-->
         ...
         <div class="row">
            <div class="col-md-12">
               ...
               <div class="navbar-header">
                  ...
                  <a class="navbar-brand sticky_logo" href="index.jpg"><img src="images/logowhite.jpg" class="logo" alt=""></a>
               </div>
   ...
   <div class="container">
      <div class="row">
         <div class="col-md-12 text-center">
            <h1 class="text-uppercase">Property Details - 3</h1>
...
<?php
				...
				$query = "SELECT *
						...
						INNER JOIN registration ON registration.id = propertydetails.regi_id
   ...
   <div class="container property-details">
      ...
      <div class="row">
         <div class="col-md-12">
            <h2 class="text-uppercase"><?php echo $row['protype'] ?> In <?php echo $row['city'] ?></h2>
			<p class="bottom30">Street :<?php echo $row['street'] ?>, Locality : <?php echo $row['locality'] ?></p>
            
            <div id="property-d-1" class="owl-carousel single">
               <div class="item"><img src='<?php echo $row['image'] ?>' alt="image"/></div>
               <div class="item"><img src='<?php echo $row['image1'] ?>' alt="image"/></div>
               <div class="item"><img src='<?php echo $row['image2'] ?>' alt="image"/></div>
               <div class="item"><img src='<?php echo $row['image3'] ?>' alt="image"/></div>
               <div class="item"><img src='<?php echo $row['image4'] ?>' alt="image"/></div>
            ...
            <div class="property_meta bg-black bottom40">
               <span><i class="icon-select-an-objecto-tool"></i><?php echo $row['builtup'] ?>Sq. Ft.</span>
               <span><i class=" icon-microphone"></i><?php echo $row['bedroom'] ?></span>
               <span><i class="icon-safety-shower"></i><?php echo $row['bathroom'] ?></span>
               <span><i class="icon-old-television"></i>For : <?php echo $row['type'] ?></span>
              
            </div>
         </div>
         <div class="col-md-8 listing1">
		
            <h2 class="text-uppercase">Quick Summary</h2>
           <div class="row property-d-table bottom40">
               <div class="col-md-6 col-sm-6 col-xs-12">
                  <table class="table table-striped table-responsive">
                     <tbody>
                        ...
                        <tr>
                           <td><b>Status</b></td>
                           <td class="text-right"><?php echo $row['type'] ?></td>
                        </tr>
               ...
               <div class="col-md-6 col-sm-6 col-xs-12">
                  <table class="table table-striped table-responsive">
                     <tbody>
                        <tr>
                           <td><b>Property age</b></td>
                           <td class="text-right"><?php echo $row['age'] ?></td>
                        </tr>
                       <tr>
                           <td><b>Property Size</b></td>
                           <td class="text-right"><?php echo $row['builtup'] ?></td>
                        </tr>
          ...
          <!-- <h2 class="text-uppercase bottom20">Video Presentation</h2>
            ...
            <h2 class="text-uppercase bottom20">Contact <?php echo $row['category'] ?></h2>
            <div class="row">
			
               <div class="col-sm-6 bottom40">
                  <div class="agent_wrap">
                     <div class="image">
                        <img src="<?php echo $row['regi_image'] ?>" alt="Agents">
                     </div>
                  </div>
               </div>
               <div class="col-sm-6 bottom40">
                  <div class="agent_wrap">
                     <h3><?php echo $row['username'] ?></h3>
							<p>Mobile :  <?php echo $row['conpass'] ?></p>
               ...
               <div class="col-sm-12 bottom40">
                  <form class="callus" action="contact.php?username=<?php echo $row['username']; ?>" method="post">
                     <div class="row">
                        <div class="col-sm-6">
                           ...
                           <div class="form-group">
                              <input type="tel" class="form-control" placeholder="Phone Number" name="no">
                           </div>
                           <div class="form-group">
                        ...
                        <div class="col-sm-6">
						   ...
						   <div class="col-sm-6">
                             ...
                             <input type="submit" value="Send Enquiry" class="btn-blue">
							  </div>
                        </div>
            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
                  <table class="table table-striped table-responsive">
                     <tbody>
                        <tr>
                           <td><b>Bedroom</b></td>
                           <td class="text-right"><?php echo $row['bedroom'] ?></td>
                        </tr>
                        <tr>
                           <td><b>Bathroom</b></td>
                           <td class="text-right"><?php echo $row['bathroom'] ?></td>
                        </tr>
                        ...
                        <div class="property_item heading_space">
                           ...
                           <div class="proerty_content">
                              ...
                              <div class="favroute clearfix">
                                 ...
                                 <ul class="pull-right">
                                    <li><a href="#."><i class="icon-like"></i></a></li>
                                    <li><a href="#fourty" class="share_expender" data-toggle="collapse"><i class="icon-share3"></i></a></li>
                                 </ul>
                              </div>
                              <div class="toggle_share collapse" id="fourty">
                                 <ul>
                                    <li><a href="#." class="facebook"><i class="icon-facebook-1"></i> Facebook</a></li>
                                    <li><a href="#." class="twitter"><i class="icon-twitter-1"></i> Twitter</a></li>
                                    <li><a href="#." class="vimo"><i class="icon-vimeo3"></i> Vimeo</a></li>
                        ...
                        <div class="property_item heading_space">
                           ...
                           <div class="proerty_content">
                              ...
                              <div class="favroute clearfix">
                                 ...
                                 <ul class="pull-right">
                                    <li><a href="#."><i class="icon-like"></i></a></li>
                                    <li><a href="#sixty" class="share_expender" data-toggle="collapse"><i class="icon-share3"></i></a></li>
                                 </ul>
                              </div>
                              <div class="toggle_share collapse" id="sixty">
                                 <ul>
                                    <li><a href="#." class="facebook"><i class="icon-facebook-1"></i> Facebook</a></li>
                                    <li><a href="#." class="twitter"><i class="icon-twitter-1"></i> Twitter</a></li>
                                    <li><a href="#." class="vimo"><i class="icon-vimeo3"></i> Vimeo</a></li>
...
function myFunction() 
{
  alert("Request Do you really want to send Request");
}
</script>
</body>
</html>
