	...
	<div class="container">
		<div class="row">
          ...
          <div class="header-thumb">
            <h1 class="wow fadeIn" data-wow-delay="1.6s"> Hello,</h1>
			<h1 class="wow fadeIn" data-wow-delay="1.6s">My name is Chanchal Bendkule</h1>
            <h2 class="wow fadeInUp" data-wow-delay="1.9s">
			 I'm a web devloper lives in nashik. I make Websites usually in PHP. Feel Free to take a look at my projects.</h2>
          </div>
			</div>
      ...
      <div class="row">
         ...
         <div class="col-md-12 col-sm-12">
               ...
               <div class="iso-section wow fadeInUp" data-wow-delay="2.6s">
                  ...
                  <ul class="filter-wrapper clearfix" id="project">
                           <li><a href="#" data-filter="*" class="selected opc-main-bg"align="center" >My Projects</a></li>
                           ...
                           <div class="iso-box-wrapper col4-iso-box">
                              ...
                              <div class="iso-box photoshop branding col-md-4 col-sm-6">
                                 <div class="portfolio-thumb">
                                    <img src="images/banner1.jpg" class="img-responsive" alt="Portfolio">
                                       <div class="portfolio-overlay">
                                          <div class="portfolio-item">
                                                <a href="realestate.php"><i class="fa fa-link"></i></a>
                                                <h2>Project One</h2>
                                             </div>
                                       </div>
                                 </div>
