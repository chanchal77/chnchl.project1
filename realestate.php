		...
		<div class="row">
			...
			<div class="col-md-offset-3 col-md-6 col-sm-offset-2 col-sm-8">
           		 <div class="header-thumb">
              		 <h1 class="wow fadeIn" data-wow-delay="1.6s">Realestate System</h1>
              		 <h3 class="wow fadeInUp" data-wow-delay="1.9s">Book your house from anywhare, anytime</h3>
           		 </div>
			</div>
      ...
      <div class="row">
         ...
         <div class="wow fadeInUp col-md-offset-1 col-md-3 col-sm-offset-1 col-sm-4" data-wow-delay="2.3s">
			<div class="project-info">
				<h4>Client</h4>
				<p>Agents</p><br><p>Builders</p><br><p>Users</p>
			</div>
			<div class="project-info">
				<h4>Date</h4>
				<hp>15 April 2019</p>
		...
		<div class="wow fadeInUp col-md-7 col-sm-7" data-wow-delay="2.6s">
			<p>In this project i've used HTML,CSS,BOOTSTRAP,JAVASCRIPT for front end. And PHP,MYSQL used for back end.</p>
			...
			<div >
				...
				<a href ="Realestate/index.php"><button class="btn">Go to site</button></a>
			</div>
